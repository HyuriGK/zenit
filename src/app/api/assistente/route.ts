...
export async function POST(request: Request) {
  ...
  try {
    ...
    const [agendaRecente, agendaFutura, resumoMensal, transacoesRelevantes, contas, objetivos] = await Promise.all([
